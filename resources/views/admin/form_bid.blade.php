                            ...
                            <table class="table" id="serviceTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><textarea class="textarea service-description" name="service_description[]"></textarea></td>
                                        <td>
                                            <div class="input-price"><input type="text" class="form-control price" name="price[]"></div>
                                        </td>
                                    </tr>
                                    <tr>
